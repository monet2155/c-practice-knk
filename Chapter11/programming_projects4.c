/**
 * Modify the poker.c program of Section 10.5 by moving all external variables into main and
 * modifying functions so that they communicate by passing arguments.
